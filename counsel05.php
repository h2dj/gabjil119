    ...
    <div id="job119_contents">
      ...
      <div class="counseling_txt01">
        ...
        <ul class="counseling_txt_tab">
          ...
          <li class="active"><a href="<?php echo G5_URL ?>/counsel05.php">휴가</a></li>
        ...
        <ul class="counseling_txt_video_list">
          <li><img src="images/counseling/play_btn_active.png" alt="재생 중" class="pc"><span>실업급여 받으려면 어떻게 해야 하나요?</span></li>
          <li><img src="images/counseling/play_btn.png" alt="재생목록" class="pc"><span>자진퇴사인데도 실업급여를 받을 수 있다고?</span></li>
        </ul>

        <ul class="counseling_txt_video_list">
          <li><img src="images/counseling/play_btn.png" alt="재생목록" class="pc"><span>연차휴가가 뭐에요?</span></li>
          <li><img src="images/counseling/play_btn_active.png" alt="재생 중" class="pc"><span>공휴일은 쉬는 날이 아닌가요?</span></li>
        </ul>
