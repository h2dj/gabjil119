...
?>
    ...
    <div id="job119_contents">
      ...
      <div class="counseling_txt01">
        ...
        <div style="height: 500px;width: 55%;margin: 10% 0 0 60%;">
          <h2 style="font-size:2.5em;color:#aaa;">(준비중)</h2>
        </div>
        

        <!-- <ul class="counseling_txt_tab">
          <li class="active"><a href="<?php echo G5_URL ?>/bbs/board.php?bo_table=sabasam">실업급여</a></li>
