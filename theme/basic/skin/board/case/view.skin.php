...
<div id="board_contents">
    ...
    <!-- 게시물 읽기 시작 { -->
    <div class="case_detail_board">
        <div class="case_board_title">
            <h2>
        ...
        <div class="case_detail_board_footer">
            <div class="case_board_footer_line"></div>
            ...
            <div class="case_board_footer_list_btn">
