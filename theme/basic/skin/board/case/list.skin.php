...
<div id="board_contents">
    <!-- <ul class="path pc">
        ...
        <li><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=case">승리사례모음집</a></li>
    </ul> -->
    ...
    <div class="case_main">
        <img src="<?php echo G5_URL ?>/images/case/case_main_icon.png" alt="승리사례모음집"><br>
        <img src="<?php echo G5_URL ?>/images/case/case_main_txt.png" alt="승리사례모음집"><br>
        <h2>119가 선정한 갑질뿌수기 사례</h2>
    </div>
    
    <!-- 게시판 목록 시작 { -->
    <div class="case_board_wrap">
        ...
        <table class="case_board">
            ...
            ?>
                ...
                ?>
                    ...
                    <td class="case_board_date"><?php echo str_replace('-', '.', $list[$i]['datetime']) ?></td>
                    <td class="case_board_view"><?php echo $list[$i]['wr_hit'] ?></td>
                </tr>
            <?php } ?>
        ...
        <div class="case_board_footer">
            <div class="case_board_footer_btn">
            <?php if ($is_checkbox) { ?>
            ...
            <!-- 페이지 -->
            <div class="case_board_footer_pagenation">
            <?php echo $write_pages; ?>
            </div>
            <!-- 페이지 -->
            <div class="case_board_footer_write">
