...
<div id="board_contents">
    ...
    <!-- 게시물 읽기 시작 { -->
    <div class="knowhow_detail_board">
        <div class="knowhow_board_title">
            <h2>
        ...
        <div class="knowhow_board_contents">
        ...
        <div class="knowhow_detail_board_footer">
            <div class="knowhow_board_footer_line"></div>
            ...
            <div class="knowhow_board_footer_list_btn">
