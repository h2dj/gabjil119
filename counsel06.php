    ...
    <div id="job119_contents">
      ...
      <div class="counseling_txt01">
        ...
        <ul class="counseling_txt_tab">
          ...
          <li class="active"><a href="<?php echo G5_URL ?>/counsel06.php">성희롱/모성</a></li>
          <li><a href="<?php echo G5_URL ?>/counsel07.php">법적절차</a></li>
        </ul>

        <ul class="counseling_txt_video_list">
          <li><img src="images/counseling/play_btn.png" alt="재생목록" class="pc"><span>상사한테 성희롱을 당했어요.</span></li>
          <li><img src="images/counseling/play_btn_active.png" alt="재생 중" class="pc"><span>임신한 당신이 알아야 할 노동법</span></li>
          <li><img src="images/counseling/play_btn.png" alt="재생목록" class="pc"><span>육아휴직, 왜 마음대로 못 쓰게 하나요?</span></li>
          <li><img src="images/counseling/play_btn.png" alt="재생목록" class="pc"><span>고객에게 성희롱을 당했어요</span></li>
        </ul>
