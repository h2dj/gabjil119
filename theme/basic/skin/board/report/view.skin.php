...
<div id="board_contents">
        ...
        <div class="leftside_nav">
            ...
            <ul class="side_nav">
                ...
                <li class="side_nav_sub_menu">
                    <a href="<?php echo G5_URL ?>/" class="side_nav_sub_menu_btn"><span>소개</span><i class="fas fa-angle-down"></i></a>
                    <ul>
                ...
                <li class="side_nav_sub_menu">
                    <a href="<?php echo G5_URL ?>/support01.php" class="side_nav_sub_menu_btn"><span>후원참여</span><i class="fas fa-angle-down"></i></a>
                    <ul>
    ...
    <div class="report_detail_board">
        ...
        <div class="report_board_contents">
        ...
        <div class="report_detail_board_footer">
            <div class="report_board_footer_line"></div>
            ...
            <div class="report_board_footer_list_btn">
