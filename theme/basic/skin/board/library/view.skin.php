...
<div id="board_contents">
    ...
    <!-- 게시물 읽기 시작 { -->
    <div class="library_detail_board">
        <div class="library_board_title">
            <h2>
        ...
        <div class="library_board_contents">
        ...
        <div class="library_detail_board_footer">
            <div class="library_board_footer_line"></div>
            ...
            <div class="library_board_footer_list_btn">
