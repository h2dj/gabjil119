...
<div id="board_contents">
    ...
    <aside class="board_side_nav_wrap pc">
        <div class="leftside_nav">
            ...
            <li class="active"><a href="<?php echo G5_BBS_URL ?>/board.php?bo_table=library">자료실</a></li>
    ...
    <div class="library_board_wrap">
        ...
        <table class="library_board">
            ...
            ?>
                ...
                ?>
                    ...
                    <td class="library_board_contents">
                        <?php
                    ...
                    <td class="library_board_date"><?php echo str_replace('-', '.', $list[$i]['datetime']) ?></td>
                    <td class="library_board_view"><?php echo $list[$i]['wr_hit'] ?></td>
                </tr>
            <?php } ?>
        ...
        <div class="library_board_footer">
            <div class="library_board_footer_btn">
            <?php if ($is_checkbox) { ?>
            ...
            <!-- 페이지 -->
            <div class="library_board_footer_pagenation">
            <?php echo $write_pages; ?>
            </div>
            <!-- 페이지 -->
            <div class="library_board_footer_write">
