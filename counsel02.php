    ...
    <div id="job119_contents">
      ...
      <div class="counseling_txt01">
        ...
        <ul class="counseling_txt_tab">
          ...
          <li class="active"><a href="<?php echo G5_URL ?>/counsel02.php">체불임금</a></li>
        ...
        <ul class="counseling_txt_video_list">
          <li><img src="images/counseling/play_btn.png" alt="재생목록" class="pc"><span>떼인 돈 받으려면? 수당의 모든 것!</span></li>
          <li><img src="images/counseling/play_btn_active.png" alt="재생 중" class="pc"><span>연봉제 계약일 경우 수당을 안줘도 되나요?</span></li>
          <li><img src="images/counseling/play_btn.png" alt="재생목록" class="pc"><span>떼인 돈 신고하려면 어떻게 해야 하죠?</span></li>
        </ul>
